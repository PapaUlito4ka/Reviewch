...
class Review(models.Model):
    ...
    images = ArrayField(models.CharField(max_length=512, null=False))
    rating = models.IntegerField(null=False)

    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='reviews')
    user_ratings = models.ManyToManyField(User, through='UserReviewRating', related_name='rated_reviews')
